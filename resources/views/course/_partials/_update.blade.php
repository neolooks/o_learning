<form action="/store_course" method="POST" enctype="multipart/form-data">
    ...
    <input type="hidden" value="{{$course->id}}" class="form-control" id="id" name="id">
    ...
    <div class="col-md-12 form-content" >
        ...
        <div class="col-md-12 col-md-6">
            <div class="form-group {{ $errors->has('category') ? 'has-error' : ''}}"">
                ...
                <select class="form-control" name="category" id="category">
                    <option value="{{$course->category}}">{{$course->name}}</option>
        ...
        <div class="col-md-12 col-md-12">
                <div class="form-group {{ $errors->has('sub_title') ? 'has-error' : ''}}">
                    ...
                    <input type="text" value="{{$course->sub_title}}" name="sub_title" class="form-control" id="sub_title">
        ...
        <div class="col-md-12 col-md-12">
                <div class="form-group {{ $errors->has('description') ? 'has-error' : ''}}">
                    ...
                    <textarea name="description" rows="6" class="form-control" id="description">{{$course->description}}</textarea>
    ...
    <div class="col-md-12 form-content" >
        ...
        <div class="col-md-12 col-md-6">
            <div class="form-group">
                ...
                <input type="text" value="{{$course->tool_knowledge}}" class="form-control" id="tool_knowledge" name="tool_knowledge">
            </div>
        </div>
        ...
        <div class="col-md-12 col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" value="{{$course->take_course}}" name="take_course" class="form-control" id="take_course">
                </div>
        </div>
        ...
        <div class="col-md-12 col-md-12">
                <div class="form-group">
                    ...
                    <textarea name="achievement" rows="8" class="form-control" id="achievement">{{$course->achievement}}</textarea>
                </div>
        </div>
